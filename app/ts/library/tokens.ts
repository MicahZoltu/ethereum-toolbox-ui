import { ObjectTupleToValueArray, ObjectUnionToKeyedObjectUnion, UnionToIntersection } from "./typescript.js"
...
export const tokensByAddress: UnionToIntersection<ObjectUnionToKeyedObjectUnion<typeof tokensArray[number], 'address'>> = addressKeyed as UnionToIntersection<ObjectUnionToKeyedObjectUnion<typeof tokensArray[number], 'address'>>
